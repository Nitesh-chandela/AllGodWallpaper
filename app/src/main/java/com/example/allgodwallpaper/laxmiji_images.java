...
public class laxmiji_images extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_laxmiji_images);
        ...
        TypedArray card_img = getResources().obtainTypedArray(R.array.laxmiji_arr);
        ...
        shivjiAdapter adapter = new shivjiAdapter(final_img,getApplicationContext(),"l");
