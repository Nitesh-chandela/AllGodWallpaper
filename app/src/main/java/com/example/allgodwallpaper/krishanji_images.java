...
public class krishanji_images extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_krishanji_images);
        ...
        TypedArray card_img = getResources().obtainTypedArray(R.array.krishanji_arr);
        ...
        shivjiAdapter adapter = new shivjiAdapter(final_img,getApplicationContext(),"kr");
