...
public class sherovalimata_images extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sherovalimata_images);
        ...
        TypedArray card_img = getResources().obtainTypedArray(R.array.sherovalimata_arr);
        ...
        shivjiAdapter adapter = new shivjiAdapter(final_img, getApplicationContext(),"sh");
