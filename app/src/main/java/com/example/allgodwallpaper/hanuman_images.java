...
public class hanuman_images extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_hanuman_images);
        ...
        TypedArray card_img = getResources().obtainTypedArray(R.array.hanuman_arr);
        ...
        shivjiAdapter adapter = new shivjiAdapter(final_img,getApplicationContext(),"h");
